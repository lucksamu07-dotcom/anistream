  ...
  return (
    <SessionProvider session={session}>
      <div className="relative flex min-h-screen flex-col bg-neutral-950 text-white">
        <div
          className={`fixed left-0 top-0 z-50 w-full bg-gradient-to-r from-rose-700 via-red-600 to-orange-500 px-3 py-2 text-center text-xs font-semibold text-white shadow-md sm:text-sm interactive ${
